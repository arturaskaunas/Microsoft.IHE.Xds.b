...
/*
    ...
    internal class MyServiceHost
    {
        ...
        internal static void StartService()
        {
            ...
            myServiceHost = new ServiceHost(typeof(RegistryStoredQuery.service1), baseAddress);
    ...
    <system.serviceModel>
    <services>
         <service name="RegistryStoredQuery.service1">
           <endpoint contract="RegistryStoredQuery.IService1" binding="wsHttpBinding"/>
         </service>
       </services>
    </system.serviceModel>
